[![CircleCI](https://circleci.com/gh/qlik-oss/mongocursorpagination.svg?style=svg)](https://circleci.com/gh/qlik-oss/mongocursorpagination/tree/master)
...
See [items_store_test.go](./test/integration/mgo/items_store_test.go) for the integration test that uses the [items store](./test/integration/mgo/items_store.go)'s find method.
